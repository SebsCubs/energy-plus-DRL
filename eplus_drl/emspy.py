...
class EmsPy:
    ...
    available_timing_metrics = [
        ...
        'timesteps_zone_num', 'callbacks','t_cumulative_time']
    ...
    def _update_time(self):
        ...
        cumulative_time = datax.current_sim_time(state)
        ...
        self.t_cumulative_time.append(cumulative_time)
        # holiday
